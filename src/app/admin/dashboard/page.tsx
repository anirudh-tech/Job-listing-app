...
export default function AdminDashboard() {
  ...
  const [currentView, setCurrentView] = useState<'jobs' | 'job-requests' | 'job-seekers' | 'categories' | 'contacts'>('job-requests');
  ...
  const handleViewChange = (view: 'jobs' | 'job-requests' | 'job-seekers' | 'categories' | 'contacts') => {
    setCurrentView(view);
  };

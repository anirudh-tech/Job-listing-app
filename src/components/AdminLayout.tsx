...
interface AdminLayoutProps {
  ...
  currentView: 'jobs' | 'job-requests' | 'job-seekers' | 'categories' | 'contacts';
  onViewChange: (view: 'jobs' | 'job-requests' | 'job-seekers' | 'categories' | 'contacts') => void;
  admin: any;
  onLogout: () => void;
}
                ...
                <div>
                  <h1 className="text-2xl font-bold text-gray-900">
                    {currentView === 'jobs' ? 'All Jobs' : 
                     ...
                     currentView === 'categories' ? 'Categories' : 'Job Requests'}
                  </h1>
